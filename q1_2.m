...
descriptors1 = descriptorExtract(I1, poi1);
descriptors2 = descriptorExtract(I2, poi2);

map = nnMatch(descriptors1, descriptors2, 0.6);

matchedPoints1 = poi1(map(:,1),:);
matchedPoints2 = poi2(map(:,2),:);
figure;
